...
/*! BEGIN CoreSlim */
(function(){'dont use strict';var a={};global.tab=global.tab||{};ss.initAssembly(a,'tabcoreslim');var b=global.tab.BaseLogAppender=ss.mkType(a,'tab.BaseLogAppender',function(){this.$0=null;this.$0=[]},{clearFilters:function(){ss.clear(this.$0)},addFilter:function(l){this.$0.push(l)},removeFilter:function(l){ss.remove(this.$0,l)},log:function(l,m,n,o){},logInternal:null,formatMessage:function(l,m){if(ss.isNullOrUndefined(m)||m.length===0){return l}var n=new ss.StringBuilder;var o=0;var p=false;for(var q=0;q<l.length;q++){var r=l.charCodeAt(q);if(r===37){if(p){n.append('%');p=false}else{p=true}}else{if(p){switch(r){case 98:case 115:case 100:case 110:case 111:{n.append(((m.length>o)?m[o]:''));o++;break}}}else{n.appendChar(r)}p=false}}return n.toString()}});var c=global.tab.ConsoleLogAppender=ss.mkType(a,'tab.ConsoleLogAppender',function(){this.$2=null;b.call(this)},{logInternal:function(l,m,n,o){if(typeof(window.console)!=='object'){return}n=l.get_name()+': '+n;var p=[];var q=p.concat(n);p=q.concat.apply(q,o);try{Function.prototype.apply.call(this.$1(m),window.console,p)}catch(r){}},$1:function(l){var m=window.self['console'];if(ss.isNullOrUndefined(this.$2)){this.$2={};this.$2[(1).toString()]=m.log;this.$2[(4).toString()]=m.error;this.$2[(2).toString()]=m.info;this.$2[(3).toString()]=m.warn}var n=this.$2[l.toString()];if(ss.isNullOrUndefined(n)){n=m.log}return n}});var d=global.tab.EscapingUtil=ss.mkType(a,'tab.EscapingUtil',null,null,{escapeHtml:function(l){var m=ss.coalesce(l,'');m=m.replace(new RegExp('&','g'),'&amp;');m=m.replace(new RegExp('<','g'),'&lt;');m=m.replace(new RegExp('>','g'),'&gt;');m=m.replace(new RegExp('"','g'),'&quot;');m=m.replace(new RegExp("'",'g'),'&#39;');m=m.replace(new RegExp('/','g'),'&#47;');if((new RegExp('^ +$')).test(m)){m=m.replace(new RegExp(' ','g'),'&nbsp;')}return m}});var e=global.tab.Log=ss.mkType(a,'tab.Log',function(){},null,{get:function(l){return g.lazyGetLogger(ss.getInstanceType(l))},get$1:function(l){return g.lazyGetLogger(l)}});var f=global.tab.LogAppenderInstance=ss.mkType(a,'tab.LogAppenderInstance',function(l){this.$0=null;this.$1$1=null;this.$0=l},{get_instance:function(){return this.$1$1},set_instance:function(l){this.$1$1=l},enableLogging:function(l){if(ss.isNullOrUndefined(this.get_instance())){this.set_instance(this.$0());g.addAppender(this.get_instance())}else if(!g.hasAppender(this.get_instance())){g.addAppender(this.get_instance())}this.get_instance().addFilter(ss.coalesce(l,function(m,n){return true}))},disableLogging:function(){if(ss.isNullOrUndefined(this.get_instance())){return}g.removeAppender(this.get_instance());this.set_instance(null)}});var g=global.tab.Logger=ss.mkType(a,'tab.Logger',function(l){this.$1=null;this.$1=l},{get_name:function(){return this.$1},debug:function(l,m){},info:function(l,m){},warn:function(l,m){},error:function(l,m){},log:function(l,m,n){},$0:function(l,m,n){try{for(var o=0;o<g.$3.length;o++){var p=g.$3[o];p.log(this,l,m,n)}}catch(q){}}},{get_globalLog:function(){return g.global},clearFilters:function(){for(var l=0;l<g.$3.length;l++){var m=g.$3[l];m.clearFilters()}g.$4.splice(0,g.$4.length)},filterByLogger:function(l,m){m=m||0;g.$0(function(n,o){return ss.referenceEquals(n,l)&&o>=m})},filterByType:function(l,m){m=m||0;g.$0(function(n,o){return o>=m&&ss.referenceEquals(n.get_name(),ss.getTypeName(l))})},filterByName:function(l,m){m=m||0;var n=new RegExp(l,'i');g.$0(function(o,p){return p>=m&&ss.isValue(o.get_name().match(n))})},clearAppenders:function(){g.$3.splice(0,g.$4.length)},hasAppender:function(l){return g.$3.indexOf(l)>-1},addAppender:function(l){for(var m=0;m<g.$4.length;m++){var n=g.$4[m];l.addFilter(n)}g.$3.push(l)},removeAppender:function(l){var m=g.$3.indexOf(l);if(m>-1){g.$3.splice(m,1)}},lazyGetLogger:function(l){var m='_logger';var n=l[m];if(ss.isNullOrUndefined(n)){n=g.getLogger(l,null);l[m]=n}return n},getLogger:function(l,m){var n=g.getLoggerWithName(ss.getTypeName(l));if(ss.isValue(m)){}return n},getLoggerWithName:function(l){return g.$6},$1:function(){var l=j.getUriQueryParameters(window.self.location.search);if(!ss.keyExists(l,':log')){return}var m=l[':log'];if(m.length===0){}for(var n=0;n<m.length;n++){var o=m[n];var p=o.split(String.fromCharCode(58));var q=1;if(p.length>0&&ss.isValue(p[1])){var r=p[1].toLowerCase();var s=g.loggerLevelNames.indexOf(r);if(s>=0){q=s}}}},$0:function(l){g.$4.push(l);for(var m=0;m<g.$3.length;m++){var n=g.$3[m];n.addFilter(l)}}});var h=global.tab.LoggerLevel=ss.mkEnum(a,'tab.LoggerLevel',{all:0,debug:1,info:2,warn:3,error:4,off:5});var i=global.tab.ScriptEx=ss.mkType(a,'tab.ScriptEx');var j=global.tab.UriExtensions=ss.mkType(a,'tab.UriExtensions',null,null,{getUriQueryParameters:function(l){var m={};if(ss.isNullOrUndefined(l)){return m}var n=l.indexOf('?');if(n<0){return m}var o=l.substr(n+1);var p=o.indexOf('#');if(p>=0){o=o.substr(0,p)}if(ss.isNullOrEmptyString(o)){return m}var q=o.split('&');for(var r=0;r<q.length;r++){var s=q[r];var t=s.split('=');var u=decodeURIComponent(t[0]);var v;if(ss.keyExists(m,u)){v=m[u]}else{v=[];m[u]=v}if(t.length>1){v.push(decodeURIComponent(t[1]))}}return m}});var k=global.tab.WindowHelper=ss.mkType(a,'tab.WindowHelper',function(l){this.$0=null;this.$0=l},{get_pageXOffset:function(){return k.$9(this.$0)},get_pageYOffset:function(){return k.$a(this.$0)},get_clientWidth:function(){return k.$4(this.$0)},get_clientHeight:function(){return k.$3(this.$0)},get_innerWidth:function(){return k.$6(this.$0)},get_outerWidth:function(){return k.$8(this.$0)},get_innerHeight:function(){return k.$5(this.$0)},get_outerHeight:function(){return k.$7(this.$0)},get_screenLeft:function(){return k.$b(this.$0)},get_screenTop:function(){return k.$c(this.$0)},isQuirksMode:function(){return document.compatMode==='BackCompat'}},{get_windowSelf:function(){return window.self},get_windowParent:function(){return window.parent},get_selection:function(){if(typeof(window['getSelection'])==='function'){return window.getSelection()}if(typeof(document['getSelection'])==='function'){return document.getSelection()}return null},close:function(l){l.close()},getOpener:function(l){return l.opener},getLocation:function(l){return l.location},getPathAndSearch:function(l){return l.location.pathname+l.location.search},setLocationHref:function(l,m){l.location.href=m},locationReplace:function(l,m){l.location.replace(m)},open:function(l,m,n){return window.open(l,m,n)},reload:function(l,m){l.location.reload(m)},requestAnimationFrame:function(l){return k.$d(l)},cancelAnimationFrame:function(l){if(ss.isValue(l)){k.$2(l)}},setTimeout:function(l,m){return window.setTimeout(l,m)},setInterval:function(l,m){return window.setInterval(l,m)},addListener:function(l,m,n){if('addEventListener'in l){l.addEventListener(m,n,false)}else{l.attachEvent('on'+m,n)}},removeListener:function(l,m,n){if('removeEventListener'in l){l.removeEventListener(m,n,false)}else{l.detachEvent('on'+m,n)}},$0:function(){var l=0;k.$d=function(m){var n=(new Date).getTime();var o=Math.max(0,16-(n-l));l=n+o;var p=window.setTimeout(m,o);return p}},clearSelection:function(){var l=k.get_selection();if(ss.isValue(l)){if(typeof(l['removeAllRanges'])==='function'){l.removeAllRanges()}else if(typeof(l['empty'])==='function'){l['empty']()}}}});ss.initClass(b);ss.initClass(c,b);ss.initClass(d);ss.initClass(e);ss.initClass(f);ss.initClass(g);ss.initClass(i);ss.initClass(j);ss.initClass(k);(function(){g.global=g.getLoggerWithName('global');g.loggerLevelNames=[];g.$5=':log';g.$3=[];g.$4=[];g.$6=new g('');g.loggerLevelNames[0]='all';g.loggerLevelNames[1]='debug';g.loggerLevelNames[2]='info';g.loggerLevelNames[3]='warn';g.loggerLevelNames[4]='error';g.loggerLevelNames[5]='off'})();(function(){c.globalAppender=new f(function(){return new c})})();(function(){k.blank='_blank';k.$6=null;k.$5=null;k.$4=null;k.$3=null;k.$9=null;k.$a=null;k.$b=null;k.$c=null;k.$8=null;k.$7=null;k.$d=null;k.$2=null;if('innerWidth'in window){k.$6=function(t){return t.innerWidth}}else{k.$6=function(t){return t.document.documentElement.offsetWidth}}if('outerWidth'in window){k.$8=function(t){return t.outerWidth}}else{k.$8=k.$6}if('innerHeight'in window){k.$5=function(t){return t.innerHeight}}else{k.$5=function(t){return t.document.documentElement.offsetHeight}}if('outerHeight'in window){k.$7=function(t){return t.outerHeight}}else{k.$7=k.$5}if('clientWidth'in window){k.$4=function(t){return t['clientWidth']}}else{k.$4=function(t){return t.document.documentElement.clientWidth}}if('clientHeight'in window){k.$3=function(t){return t['clientHeight']}}else{k.$3=function(t){return t.document.documentElement.clientHeight}}if(ss.isValue(window.self.pageXOffset)){k.$9=function(t){return t.pageXOffset}}else{k.$9=function(t){return t.document.documentElement.scrollLeft}}if(ss.isValue(window.self.pageYOffset)){k.$a=function(t){return t.pageYOffset}}else{k.$a=function(t){return t.document.documentElement.scrollTop}}if('screenLeft'in window){k.$b=function(t){return t.screenLeft}}else{k.$b=function(t){return t.screenX}}if('screenTop'in window){k.$c=function(t){return t.screenTop}}else{k.$c=function(t){return t.screenY}}{var l='requestAnimationFrame';var m='cancelAnimationFrame';var n=['ms','moz','webkit','o'];var o=null;var p=null;if(l in window){o=l}if(m in window){p=m}for(var q=0;q<n.length&&(ss.isNullOrUndefined(o)||ss.isNullOrUndefined(p));++q){var r=n[q];var s=r+'RequestAnimationFrame';if(ss.isNullOrUndefined(o)&&s in window){o=s}if(ss.isNullOrUndefined(p)){s=r+'CancelAnimationFrame';if(s in window){p=s}s=r+'CancelRequestAnimationFrame';if(s in window){p=s}}}if(ss.isValue(o)){k.$d=function(t){return window[o](t)}}else{k.$0()}if(ss.isValue(p)){k.$2=function(t){window[p](t)}}else{k.$2=window.clearTimeout}}})()})();var tab=global.tab;global.tableauSoftware=global.tableauSoftware||{};
/*! BEGIN ApiShared */
